...
{
    public class LCUObtenerLineaDePedidoById
    {
        private readonly LIPedidoRepositorio _pedidoRepositorio;

        public LCUObtenerLineaDePedidoById(LIPedidoRepositorio pedidoRepositorio)
        {
            _pedidoRepositorio = pedidoRepositorio;
        }

        public async Task<LineaPedido> Execute(int idLineaPedido, int idPedido)
        {
